        ...
        <Fragment>
            ...
            >
                <DialogContent className="max-h-full overflow-auto">
                    ...
                    <div>
                        {selectedServingGuest &&
                            Object.keys(selectedServingGuest).map(
                                (guestId, index) => {
                                    const orders =
                                        selectedServingGuest[Number(guestId)];
                                    return (
                                        <div key={guestId}>
                                            <OrderGuestDetail
                    ...
                    if (tableStatics) {
                        for (const guestId in tableStatics) {
                            ...
                            countObject = {
                                Pending:
                                    countObject.Pending +
                                    (guestStatics.Pending ?? 0),
                                Processing:
                                    countObject.Processing +
                                    (guestStatics.Processing ?? 0),
                                Delivered:
                                    countObject.Delivered +
                                    (guestStatics.Delivered ?? 0),
                                Paid:
                                    countObject.Paid + (guestStatics.Paid ?? 0),
                                Rejected:
                                    countObject.Rejected +
                                    (guestStatics.Rejected ?? 0),
                            };
                        }
                    }
                    return (
                        ...
                        >
                            <div className="flex flex-col items-center justify-center gap-2">
                                ...
                                <TooltipProvider>
                                    <Tooltip>
                                        ...
                                        <TooltipContent>
                                            Đang phục vụ: {servingGuestCount}{" "}
                                            khách
                                        </TooltipContent>
                                    </Tooltip>
                                </TooltipProvider>
                            ...
                            <Separator
                                ...
                                className={cn(
                                    "flex-shrink-0 flex-grow h-auto",
                                    {
